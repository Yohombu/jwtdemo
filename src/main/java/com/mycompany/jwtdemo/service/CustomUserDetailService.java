...
//        if(userName.equals("John")){ //here you can make a DB call with the help of the repository and do the validation
//            return new User("John", "secret", new ArrayList<>());
//        }else{
//            throw new UsernameNotFoundException("User does not exist!");
//        }

        if(userEntity == null){ //here you can make a DB call with the help of the repository and do the validation
            throw new UsernameNotFoundException("User does not exist!");
        }
